			...
			<div class="col-lg-6 col-md-8 col-sm-9">
				...
				<nav class="tm-nav">
					<ul>
						...
						<li><a href="accContact" class="active">Contact</a></li>
		...
		<ul class="slides">
			<li>
				<div class="tm-banner-inner">
					<h1 class="tm-banner-title">Enjoy your  <span class="tm-yellow-text">Life</span> Tour</h1>
					<p class="tm-banner-subtitle">with us...</p>
					<a href="#more" class="tm-banner-link">Contact Us</a>
				</div>
				<img src="fichier/img/banner-3.jpg" alt="Banner 3" />
			</li>
		</ul>
	</div>
</section>
